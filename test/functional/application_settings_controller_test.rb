...
class ApplicationSettingsControllerTest < ActionController::TestCase
  ...
  test "should create application_setting" do
    assert_difference('ApplicationSetting.count') do
      post :create, application_setting: { name: @application_setting.name, trigger: @application_setting.trigger, value: @application_setting.value }
    end
  ...
  test "should update application_setting" do
    put :update, id: @application_setting, application_setting: { name: @application_setting.name, trigger: @application_setting.trigger, value: @application_setting.value }
    assert_redirected_to application_setting_path(assigns(:application_setting))
  end
